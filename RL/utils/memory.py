...
class ReplayMemory:
    ...
    def sample_batch(self, batch_size: int) -> tuple:
        ...
        states, actions, rewards, discounts, next_states, next_actions, dones = self.get_batch(indices)
    ...
    def get_batch(self, indices: np.array) -> tuple:
        ...
        return tuple((states, actions, rewards, discounts, next_states, next_actions, dones))
